...
const (
	...
	Review_SaveReply_FullMethodName    = "/api.review.v1.Review/SaveReply"
...
type ReviewClient interface {
	...
	// 保存评价回复
	SaveReply(ctx context.Context, in *SaveReplyRequest, opts ...grpc.CallOption) (*SaveReplyReply, error)
	// 审核评价
...
func (c *reviewClient) SaveReply(ctx context.Context, in *SaveReplyRequest, opts ...grpc.CallOption) (*SaveReplyReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaveReplyReply)
	err := c.cc.Invoke(ctx, Review_SaveReply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReviewServer) SaveReply(context.Context, *SaveReplyRequest) (*SaveReplyReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveReply not implemented")
}
...
func _Review_SaveReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaveReplyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).SaveReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_SaveReply_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).SaveReply(ctx, req.(*SaveReplyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Review_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Review_SaveReply_Handler,
		},
		{
