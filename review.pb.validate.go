...
// Validate checks the field values on SaveReplyRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *SaveReplyRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SaveReplyRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SaveReplyRequestMultiError, or nil if none found.
func (m *SaveReplyRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SaveReplyRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetReviewID() <= 0 {
		err := SaveReplyRequestValidationError{
			field:  "ReviewID",
	...
	if len(errors) > 0 {
		return SaveReplyRequestMultiError(errors)
	}

	return nil
}

// SaveReplyRequestMultiError is an error wrapping multiple validation errors
// returned by SaveReplyRequest.ValidateAll() if the designated constraints
// aren't met.
type SaveReplyRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SaveReplyRequestMultiError) Error() string {
...
func (m SaveReplyRequestMultiError) AllErrors() []error { return m }

// SaveReplyRequestValidationError is the validation error returned by
// SaveReplyRequest.Validate if the designated constraints aren't met.
type SaveReplyRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e SaveReplyRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SaveReplyRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SaveReplyRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SaveReplyRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SaveReplyRequestValidationError) ErrorName() string { return "SaveReplyRequestValidationError" }

// Error satisfies the builtin error interface
func (e SaveReplyRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sSaveReplyRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SaveReplyRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SaveReplyRequestValidationError{}

// Validate checks the field values on SaveReplyReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *SaveReplyReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SaveReplyReply with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in SaveReplyReplyMultiError,
// or nil if none found.
func (m *SaveReplyReply) ValidateAll() error {
	return m.validate(true)
}

func (m *SaveReplyReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SaveReplyReplyMultiError(errors)
	}

	return nil
}

// SaveReplyReplyMultiError is an error wrapping multiple validation errors
// returned by SaveReplyReply.ValidateAll() if the designated constraints
// aren't met.
type SaveReplyReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SaveReplyReplyMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SaveReplyReplyMultiError) AllErrors() []error { return m }

// SaveReplyReplyValidationError is the validation error returned by
// SaveReplyReply.Validate if the designated constraints aren't met.
type SaveReplyReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SaveReplyReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SaveReplyReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SaveReplyReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SaveReplyReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SaveReplyReplyValidationError) ErrorName() string { return "SaveReplyReplyValidationError" }

// Error satisfies the builtin error interface
func (e SaveReplyReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = SaveReplyReplyValidationError{}
...
func (m *AuditAppealRequest) validate(all bool) error {
	...
	// no validation rules for AuditRemarks

	if utf8.RuneCountInString(m.GetAuditUser()) < 1 {
		err := AuditAppealRequestValidationError{
			field:  "AuditUser",
			reason: "value length must be at least 1 runes",
		}
